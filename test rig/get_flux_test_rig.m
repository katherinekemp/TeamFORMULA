...
function totalCharge = get_flux_test_rig(turns, R_car, turns_car, radius_car, height, spacing, velocity, rho, scenarioID, BZ, X_M, Y_M, increment, meshDistance, heightIndex, numberOfSquaresX, numberOfSquaresY, outputFolder) 
    %% FORMULA Constants
