...
function totalCharge = get_flux(turns, d_car, turns_car, radius_car, height, spacing, velocity, rho, scenarioID, BZ, X_M, Y_M, maxDistance, increment, meshDistance, heightIndex, numberOfSquaresX, numberOfSquaresY, outputFolder) 
    %% FORMULA Constants
