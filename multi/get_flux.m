...
function totalCharge = get_flux(turns, wireGauge_car, turns_car, radius_car, height, spacing, velocity, scenarioID, BZ, X_M, Y_M, increment, R_car, meshDistance, heightIndex, numberOfSquaresX, numberOfSquaresY) 
    %% FORMULA Constants
